...
public class ZmanimFormatter {
	...
	/**
	 * constructor that defaults to this will use the format "h:mm:ss" for dates and 00.00.00.0 for {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Time}.
	...
	public String format(int millis) {
		return format(new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Time(millis));
	}

	/**
	 * A method that formats {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Time}objects.
	 * 
	 * @param time
	 *            The time <code>Object</code> to be formatted.
	 * @return String The formatted <code>String</code>
	 */
	public String format(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Time time) {
	...
	public String formatXSDDurationTime(long millis) {
		return formatXSDDurationTime(new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Time(millis));
	}
	...
	public static String toXML(AstronomicalCalendar astronomicalCalendar) {
		...
		String tagName = "";
		Object value = null;
		List<com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman> dateList = new ArrayList<com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman>();
		List<com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman> durationList = new ArrayList<com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman>();
			...
			if (includeMethod(theMethods[i])) {
				...
				try {
					...
					if (value == null) {// TODO: Consider using reflection to determine the return type, not the value
						...
						dateList.add(new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman((Date) value, tagName));
						...
						if (((Long) value).longValue() == Long.MIN_VALUE) {
							...
							durationList.add(new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman((int) ((Long) value).longValue(), tagName));
						}
		...
		com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman zman;
		Collections.sort(dateList, com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman.DATE_ORDER);

		for (int i = 0; i < dateList.size(); i++) {
			zman = (com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman) dateList.get(i);
			sb.append("\t<").append(zman.getLabel()).append(">");
			sb.append(formatter.formatDateTime(zman.getZman(), astronomicalCalendar.getCalendar()));
			sb.append("</").append(zman.getLabel()).append(">\n");
		}
		Collections.sort(durationList, com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman.DURATION_ORDER);
		for (int i = 0; i < durationList.size(); i++) {
			zman = (com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.Zman) durationList.get(i);
