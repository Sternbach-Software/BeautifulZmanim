...
public class Zman {
	...
	/**
	 * Returns a duration based <em>zman</em> such as {@link AstronomicalCalendar#getTemporalHour() temporal hour}
	 * (or the various <em>shaah zmanis</em> times such as {@link ZmanimCalendar#getShaahZmanisGra() <em>shaah zmanis GRA</em>}
	 * or {@link ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah zmanis 16.1&deg;</em>}).
	...
	/**
	 *  Sets a duration based <em>zman</em> such as {@link AstronomicalCalendar#getTemporalHour() temporal hour}
	 * (or the various <em>shaah zmanis</em> times as {@link ZmanimCalendar#getShaahZmanisGra() <em>shaah zmanis GRA</em>} or
	 * {@link ComplexZmanimCalendar#getShaahZmanis16Point1Degrees() <em>shaah zmanis 16.1&deg;</em>}).
	 * @param duration duration based <em>zman</em> such as {@link AstronomicalCalendar#getTemporalHour()}.
	 * @see #getDuration()
	 */
