...
import com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.NOAACalculator;
import com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.SunTimesCalculator;
import com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.ZmanimFormatter;
 ...
 * changed to a different implementation by implementing the abstract {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} and setting it with
 * the {@link #setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator)}. A number of different calculation engine
...
public class AstronomicalCalendar implements Cloneable {
	 ...
	 * <b>Note </b>: it is important to note that for sunrise and sunset the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#adjustZenith
	...
	/**
	 * the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation} used for calculations.
	 */
	private com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation geoLocation;

	/**
	 * the internal {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} used for calculating solar based times.
	 */
	private com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator astronomicalCalculator;

	/**
	 * The getSunrise method Returns a <code>Date</code> representing the
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted} sunrise time. The zenith used
	 * for the calculation uses {@link #GEOMETRIC_ZENITH geometric zenith} of 90&deg; plus
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double)}. This is adjusted by the
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} to add approximately 50/60 of a degree to account for 34 archminutes of refraction
	 * and 16 archminutes for the sun's radius for a total of {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#adjustZenith 90.83333&deg;}.
	 * See documentation for the specific implementation of the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} that you are using.
	 * 
	 ...
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#adjustZenith
	...
	/**
	 * A method that returns the sunrise without {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation
	 ...
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted} sunset time. The zenith used for
	 * the calculation uses {@link #GEOMETRIC_ZENITH geometric zenith} of 90&deg; plus
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double)}. This is adjusted by the
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} to add approximately 50/60 of a degree to account for 34 archminutes of refraction
	 * and 16 archminutes for the sun's radius for a total of {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#adjustZenith 90.83333&deg;}.
	 * See documentation for the specific implementation of the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} that you are using. Note:
	...
	/**
	 * A method that returns the sunset without {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation
	 * adjustment}. Non-sunrise and sunset calculations such as dawn and dusk, depend on the amount of visible light,
	...
	public AstronomicalCalendar() {
		this(new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation());
	}

	/**
	 * A constructor that takes in <a href="https://en.wikipedia.org/wiki/Geolocation">geolocation</a> information as a
	 * parameter. The default {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getDefault() AstronomicalCalculator} used for solar
	 * calculations is the the {@link NOAACalculator}.
	 * 
	 * @param geoLocation
	 *            The location information used for calculating astronomical sun times.
	 *
	 * @see #setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator) for changing the calculator class.
	 */
	public AstronomicalCalendar(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation geoLocation) {
		setCalendar(Calendar.getInstance(geoLocation.getTimeZone()));
		setGeoLocation(geoLocation);// duplicate call
		setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator.getDefault());
	}
	...
	/**
	 * A method that returns an {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double) elevation adjusted}
	 ...
	 * this class depend on the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} used. If this calendar instance is {@link
	 * #setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator) set} to use the {@link NOAACalculator}
	 ...
	 * 
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation#getAntimeridianAdjustment()
	...
	/**
	 * A method that returns the currently set {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation} which contains location information used for the
	 * astronomical calculations.
	 * 
	 * @return Returns the geoLocation.
	 */
	public com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation getGeoLocation() {
		return this.geoLocation;
	}

	/**
	 * Sets the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation} <code>Object</code> to be used for astronomical calculations.
	 * 
	 * @param geoLocation
	 ...
	 */
	public void setGeoLocation(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation geoLocation) {
	 ...
	 * @see #setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator)
	 */
	public com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator getAstronomicalCalculator() {
		return this.astronomicalCalculator;
	}

	/**
	 * A method to set the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} used for astronomical calculations. The Zmanim package ships
	 * with a number of different implementations of the <code>abstract</code> {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator} based on
	 ...
	 */
	public void setAstronomicalCalculator(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator astronomicalCalculator) {
	 ...
	 * <b>Note:</b> If the {@link java.util.TimeZone} in the cloned {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation} will
