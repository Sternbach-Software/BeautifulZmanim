 ...
 */
package com.kosherjava.zmanim.main.java.com.kosherjava.zmanim;
...
import com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator;
...
public class ComplexZmanimCalendar extends ZmanimCalendar {
	 ...
	 */
	protected static final double ZENITH_3_POINT_7 = AstronomicalCalendar.GEOMETRIC_ZENITH + 3.7;
	 ...
	 */
	protected static final double ZENITH_3_POINT_8 = AstronomicalCalendar.GEOMETRIC_ZENITH + 3.8;
	 ...
	 */
	protected static final double ZENITH_5_POINT_95 = AstronomicalCalendar.GEOMETRIC_ZENITH + 5.95;
	 ...
	 */
	protected static final double ZENITH_7_POINT_083 = AstronomicalCalendar.GEOMETRIC_ZENITH + 7 + (5.0 / 60);
	 ...
	 */
	protected static final double ZENITH_10_POINT_2 = AstronomicalCalendar.GEOMETRIC_ZENITH + 10.2;
	 ...
	 */
	protected static final double ZENITH_11_DEGREES = AstronomicalCalendar.GEOMETRIC_ZENITH + 11;
	 ...
	 */
	protected static final double ZENITH_11_POINT_5 = AstronomicalCalendar.GEOMETRIC_ZENITH + 11.5;
	 ...
	 * 
	 */
	protected static final double ZENITH_13_POINT_24 = AstronomicalCalendar.GEOMETRIC_ZENITH + 13.24;
	 ...
	 */
	protected static final double ZENITH_19_DEGREES = AstronomicalCalendar.GEOMETRIC_ZENITH + 19;
	 ...
	 */
	protected static final double ZENITH_19_POINT_8 = AstronomicalCalendar.GEOMETRIC_ZENITH + 19.8;
	 ...
	 * @see #getTzais120()
	 */
	protected static final double ZENITH_26_DEGREES = AstronomicalCalendar.GEOMETRIC_ZENITH + 26.0;
	 ...
	 */
	protected static final double ZENITH_4_POINT_37 = AstronomicalCalendar.GEOMETRIC_ZENITH + 4.37;
	 ...
	 */
	protected static final double ZENITH_4_POINT_61 = AstronomicalCalendar.GEOMETRIC_ZENITH + 4.61;
	 ...
	 */
	protected static final double ZENITH_4_POINT_8 = AstronomicalCalendar.GEOMETRIC_ZENITH + 4.8;
	 ...
	 */
	protected static final double ZENITH_3_POINT_65 = AstronomicalCalendar.GEOMETRIC_ZENITH + 3.65;

	/**
	 * The zenith of 3.676&deg; below {@link #GEOMETRIC_ZENITH geometric zenith} (90&deg;).
	 * @todo Add more documentation.
	 */
	protected static final double ZENITH_3_POINT_676 = AstronomicalCalendar.GEOMETRIC_ZENITH + 3.676;

	/**
	 * The zenith of 5.88&deg; below {@link #GEOMETRIC_ZENITH geometric zenith} (90&deg;).
	 * @todo Add more documentation.
	 */
	protected static final double ZENITH_5_POINT_88 = AstronomicalCalendar.GEOMETRIC_ZENITH + 5.88;
	 ...
	 */
	protected static final double ZENITH_1_POINT_583 = AstronomicalCalendar.GEOMETRIC_ZENITH + 1.583;
	 ...
	 */
	protected static final double ZENITH_16_POINT_9 = AstronomicalCalendar.GEOMETRIC_ZENITH + 16.9;
	 ...
	 */
	protected static final double ZENITH_6_DEGREES = AstronomicalCalendar.GEOMETRIC_ZENITH + 6;
	 ...
	 */
	protected static final double ZENITH_6_POINT_45 = AstronomicalCalendar.GEOMETRIC_ZENITH + 6.45;
	 ...
	 */
	protected static final double ZENITH_7_POINT_65 = AstronomicalCalendar.GEOMETRIC_ZENITH + 7.65;
	 ...
	 */
	protected static final double ZENITH_7_POINT_67 = AstronomicalCalendar.GEOMETRIC_ZENITH + 7.67;
	 ...
	 */
	protected static final double ZENITH_9_POINT_3 = AstronomicalCalendar.GEOMETRIC_ZENITH + 9.3;
	 ...
	 */
	protected static final double ZENITH_9_POINT_5 = AstronomicalCalendar.GEOMETRIC_ZENITH + 9.5;
	 ...
	 */
	protected static final double ZENITH_9_POINT_75 = AstronomicalCalendar.GEOMETRIC_ZENITH + 9.75;
	 ...
	 */
	protected static final double ZENITH_MINUS_2_POINT_1 = AstronomicalCalendar.GEOMETRIC_ZENITH - 2.1;
	 ...
	 */
	protected static final double ZENITH_MINUS_2_POINT_8 = AstronomicalCalendar.GEOMETRIC_ZENITH - 2.8;
	 ...
	 */
	protected static final double ZENITH_MINUS_3_POINT_05 = AstronomicalCalendar.GEOMETRIC_ZENITH - 3.05;
	...
	/**
	 * A constructor that takes a {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation} as a parameter.
	 * 
	 * @param location
	 *            the location
	 * 
	 * @see ZmanimCalendar#ZmanimCalendar(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation)
	 */
	public ComplexZmanimCalendar(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation location) {
		super(location);
	}

	/**
	 * Default constructor will set a default {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.GeoLocation#GeoLocation()}, a default
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getDefault() AstronomicalCalculator} and default the calendar to the current date.
	 * 
	...
	public Date getAlos60() {
		return AstronomicalCalendar.getTimeOffset(getSunrise(), -60 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getAlos96() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunrise(), -96 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getAlos90() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunrise(), -90 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getAlos120() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunrise(), -120 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getSofZmanShma3HoursBeforeChatzos() {
		return AstronomicalCalendar.getTimeOffset(getChatzos(), -180 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getSofZmanTfila2HoursBeforeChatzos() {
		return AstronomicalCalendar.getTimeOffset(getChatzos(), -120 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getMinchaGedola30Minutes() {
		return AstronomicalCalendar.getTimeOffset(getChatzos(), AstronomicalCalendar.MINUTE_MILLIS * 30);
	}
	...
	public Date getMinchaGedolaAhavatShalom() {
		...
		if (getMinchaGedola30Minutes() == null || getMinchaGedola() == null) {
			...
			return getMinchaGedola30Minutes().compareTo(AstronomicalCalendar.getTimeOffset(getChatzos(), getShaahZmanisAlos16Point1ToTzais3Point7() / 2)) > 0 ?
					getMinchaGedola30Minutes() : AstronomicalCalendar.getTimeOffset(getChatzos(), getShaahZmanisAlos16Point1ToTzais3Point7() / 2);
		}
	}
	...
	public Date getMinchaKetanaAhavatShalom() {
		return AstronomicalCalendar.getTimeOffset(getTzaisGeonim3Point8Degrees(), -getShaahZmanisAlos16Point1ToTzais3Point8() * 2.5);
	}
	...
	public Date getPlagAhavatShalom() {
		return AstronomicalCalendar.getTimeOffset(getTzaisGeonim3Point8Degrees(), -getShaahZmanisAlos16Point1ToTzais3Point8() * 1.25);
	}
	...
	public Date getBainHashmashosRT58Point5Minutes() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 58.5 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getBainHashmashosRT13Point5MinutesBefore7Point083Degrees() {
		return AstronomicalCalendar.getTimeOffset(getSunsetOffsetByDegrees(ZENITH_7_POINT_083), -13.5 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getBainHashmashosRT2Stars() {
		...
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), (sunrise.getTime() - alos19Point8.getTime()) * (5 / 18d));
	}
	...
	public Date getBainHashmashosYereim18Minutes() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), -18 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getBainHashmashosYereim16Point875Minutes() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), -16.875 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getBainHashmashosYereim13Point5Minutes() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), -13.5 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getTzais60() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 60 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getTzaisAteretTorah() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), getAteretTorahSunsetOffset() * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	private Date getZmanisBasedOffset(double hours) {
		...
		if (hours > 0) {
			return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), (long) (shaahZmanis * hours));
		} else {
			return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunrise(), (long) (shaahZmanis * hours));
		}
	}
	...
	public Date getTzais90() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 90 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getTzais120() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 120 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getTzais96() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 96 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getFixedLocalChatzos() {
		return AstronomicalCalendar.getTimeOffset(getDateFromTime(12.0 - getGeoLocation().getTimeZone().getRawOffset()
				/ (double) AstronomicalCalendar.HOUR_MILLIS, true), -getGeoLocation().getLocalMeanTimeOffset());
	}
	...
	public Date getSofZmanShmaFixedLocal() {
		return AstronomicalCalendar.getTimeOffset(getFixedLocalChatzos(), -180 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	...
	public Date getSofZmanTfilaFixedLocal() {
		return AstronomicalCalendar.getTimeOffset(getFixedLocalChatzos(), -120 * AstronomicalCalendar.MINUTE_MILLIS);
	}
	 ...
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getSofZmanKidushLevanaBetweenMoldos()
	 */
	public Date getSofZmanKidushLevanaBetweenMoldos(Date alos, Date tzais) {
		com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar jewishCalendar = new com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar();
	 ...
	 * 
	 * @see #getSofZmanKidushLevanaBetweenMoldos(Date, Date)
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getSofZmanKidushLevana15Days()
	 */
	 ...
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getTchilasZmanKidushLevana3Days()
	 */
	 ...
	 * minute and chalakim, {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getMoladAsDate()} and the not yet completed
	 ...
	 * @see #getTchilasZmanKidushLevana3Days()
	 * @see #getTchilasZmanKidushLevana7Days(Date, Date)
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getMoladAsDate()
	 */
	 ...
	 * @see #getTchilasZmanKidushLevana3Days(Date, Date)
	 * @see #getTchilasZmanKidushLevana7Days()
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.JewishCalendar#getTchilasZmanKidushLevana7Days()
	 */
	...
	public Date getSolarMidnight() {
		...
		return AstronomicalCalendar.getTimeOffset(getChatzos(), (clonedCal.getChatzos().getTime() - getChatzos().getTime()) / 2);
	}
	
	/**
	 * A method that returns the <a href="https://en.wikipedia.org/wiki/Shneur_Zalman_of_Liadi">Baal Hatanya</a>'s
	 * <em>netz amiti</em> (sunrise) without {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.util.AstronomicalCalculator#getElevationAdjustment(double)
	...
	public Date getSofZmanShmaMGA18DegreesToFixedLocalChatzos() {
		java.util.TimeZone.getTimeZone(java.time.ZoneId.of("Asia/Jerusalem")).getRawOffset();
	...
	public Date getMinchaGedolaGRAFixedLocalChatzos30Minutes() {
		return AstronomicalCalendar.getTimeOffset(getFixedLocalChatzos(), AstronomicalCalendar.MINUTE_MILLIS * 30);
	}
	...
	public Date getTzais50() {
		return AstronomicalCalendar.getTimeOffset(getElevationAdjustedSunset(), 50 * AstronomicalCalendar.MINUTE_MILLIS);
	}
