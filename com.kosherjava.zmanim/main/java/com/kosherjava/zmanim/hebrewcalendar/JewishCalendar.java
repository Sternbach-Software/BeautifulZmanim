...
public class JewishCalendar extends JewishDate {
	...
	public boolean isBirkasHachamah() {
		int elapsedDays = JewishDate.getJewishCalendarElapsedDays(getJewishYear()); //elapsed days since molad ToHu
	...
	private int getParshaYearType() {
		int roshHashanaDayOfWeek = (JewishDate.getJewishCalendarElapsedDays(getJewishYear()) + 1) % 7; // plus one to the original Rosh Hashana of year 1 to get a week starting on Sunday
	...
	public Parsha getSpecialShabbos() {
		if (getDayOfWeek() == Calendar.SATURDAY) {
			if ((getJewishMonth() == JewishDate.SHEVAT && !isJewishLeapYear()) || (getJewishMonth() == JewishDate.ADAR && isJewishLeapYear())) {
				if (getJewishDayOfMonth() == 25 || getJewishDayOfMonth() == 27 || getJewishDayOfMonth() == 29) {
					return Parsha.SHKALIM;
				}
			}
			if ((getJewishMonth() == JewishDate.ADAR && !isJewishLeapYear()) || getJewishMonth() == JewishDate.ADAR_II) {
	 ...
	 * in the {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.HebrewDateFormatter#formatYomTov(JewishCalendar)}.
	 * 
	 ...
	 * 
	 * @see com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.HebrewDateFormatter#formatYomTov(JewishCalendar)
	 */
	...
	public boolean isErevYomTovSheni() {
		...
		|| (! getInIsrael()
				&& ((getJewishMonth() == JewishDate.NISSAN && (getJewishDayOfMonth() == 15 || getJewishDayOfMonth() == 21))
				|| (getJewishMonth() == JewishDate.TISHREI && (getJewishDayOfMonth() == 15 || getJewishDayOfMonth() == 22))
	...
	public boolean isTaanisBechoros() {
	    ...
	    return getJewishMonth() == JewishDate.NISSAN && ((day == 14 && dayOfWeek != Calendar.SATURDAY) ||
	...
	public boolean isShabbosMevorchim() {
		return (getDayOfWeek() == Calendar.SATURDAY && getJewishDayOfMonth() >= 23 && getJewishDayOfMonth() <= 29 && getJewishMonth() != JewishDate.ELUL);
	}
	 ...
	 * {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.HebrewDateFormatter#formatDafYomiBavli(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.Daf)} for the ability to format the <em>daf</em> in
	 * Hebrew or transliterated <em>masechta</em> names.
	 * 
	 * @return the daf as a {@link com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.Daf}
	 */
	public com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.Daf getDafYomiBavli() {
	 ...
	 * {@link HebrewDateFormatter#formatDafYomiYerushalmi(com.kosherjava.zmanim.main.java.com.kosherjava.zmanim.hebrewcalendar.Daf)} for the ability to format the <em>daf</em>
	...
	public int getTekufasTishreiElapsedDays() {
		...
		double days = JewishDate.getJewishCalendarElapsedDays(getJewishYear()) + (getDaysSinceStartOfJewishYear()-1) + 0.5;
	...
	public boolean isVeseinTalUmatarStartDate() {
		if (inIsrael) {
			...
			if (getJewishMonth() == JewishDate.CHESHVAN && getJewishDayOfMonth() == 7) {
				return true;
			}
		} else {
	...
	public boolean isVeseinTalUmatarStartingTonight() {
		if (inIsrael) {
			...
			if (getJewishMonth() == JewishDate.CHESHVAN && getJewishDayOfMonth() == 6) {
					return true;
			}
		} else {
	...
	public boolean isVeseinTalUmatarRecited() {
		...
		if (inIsrael) {
			return getJewishMonth() != JewishDate.CHESHVAN || getJewishDayOfMonth() >= 7;
		} else {
			return getTekufasTishreiElapsedDays() >= 47;
		}
	}
	...
	public boolean isMashivHaruachStartDate() {
		return getJewishMonth() == JewishDate.TISHREI && getJewishDayOfMonth() == 22;
	}
	...
	public boolean isMashivHaruachRecited() {
		JewishDate startDate = new JewishDate(getJewishYear(), JewishDate.TISHREI, 22);
		JewishDate endDate = new JewishDate(getJewishYear(), JewishDate.NISSAN, 15);
