(function (root, factory) {
  ...
  var SuspendFunction2 = kotlin_kotlin.$_$.ld;
  ...
  var cancel_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.i2;
  ...
  var UnsupportedOperationException_init_$Init$ = kotlin_kotlin.$_$.f3;
  ...
  var IllegalStateException_init_$Init$_0 = kotlin_kotlin.$_$.n2;
  var WriterScope = kotlin_io_ktor_ktor_io.$_$.i1;
  var ReadChannelContent = kotlin_io_ktor_ktor_http.$_$.l;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.tl;
  var GlobalScope_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.y;
  var writer = kotlin_io_ktor_ktor_io.$_$.k1;
  var WriteChannelContent = kotlin_io_ktor_ktor_http.$_$.m;
  var Companion_getInstance = kotlin_io_ktor_ktor_io.$_$.h;
  var NoContent = kotlin_io_ktor_ktor_http.$_$.j;
  var ProtocolUpgrade = kotlin_io_ktor_ktor_http.$_$.k;
  ...
  var OutgoingContent = kotlin_io_ktor_ktor_http.$_$.n;
  ...
  var CompletableJob = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.r1;
  ...
  var setOf_0 = kotlin_kotlin.$_$.jb;
  ...
  var TextContent = kotlin_io_ktor_ktor_http.$_$.o;
  ...
  var reversed = kotlin_kotlin.$_$.hb;
  var LinkedHashSet_init_$Create$ = kotlin_kotlin.$_$.e1;
  var Charsets_getInstance = kotlin_io_ktor_ktor_io.$_$.g;
  var rangeTo = kotlin_kotlin.$_$.tg;
  var contains = kotlin_kotlin.$_$.qg;
  ...
  var cancel_2 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.j2;
  ...
  var IllegalStateException_init_$Init$_1 = kotlin_kotlin.$_$.p2;
  var ByteChannel = kotlin_io_ktor_ktor_io.$_$.f1;
  var copyAndClose = kotlin_io_ktor_ktor_io.$_$.a;
  var HttpMessage = kotlin_io_ktor_ktor_http.$_$.r;
  var URLBuilder = kotlin_io_ktor_ktor_http.$_$.t;
  var HeadersBuilder = kotlin_io_ktor_ktor_http.$_$.p;
  ...
  var HttpMessageBuilder = kotlin_io_ktor_ktor_http.$_$.q;
  var GMTDate = kotlin_io_ktor_ktor_utils.$_$.e;
  var Pipeline = kotlin_io_ktor_ktor_utils.$_$.i;
  var takeFrom_1 = kotlin_io_ktor_ktor_http.$_$.h1;
  ...
  var cancel_3 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.h2;
  ...
  var extendThrowable = kotlin_kotlin.$_$.ee;
  ...
  var Error_init_$Create$_0 = kotlin_kotlin.$_$.x1;
  ...
  setMetadataFor($bodyAsTextCOROUTINE$11, '$bodyAsTextCOROUTINE$11', classMeta, CoroutineImpl);
  setMetadataFor($bodyAsChannelCOROUTINE$12, '$bodyAsChannelCOROUTINE$12', classMeta, CoroutineImpl);
  ...
  setMetadataFor($executeCOROUTINE$13, '$executeCOROUTINE$13', classMeta, CoroutineImpl);
  setMetadataFor($executeUnsafeCOROUTINE$14, '$executeUnsafeCOROUTINE$14', classMeta, CoroutineImpl);
  setMetadataFor($cleanupCOROUTINE$15, '$cleanupCOROUTINE$15', classMeta, CoroutineImpl);
  ...
  setMetadataFor($executeCOROUTINE$16, '$executeCOROUTINE$16', classMeta, CoroutineImpl);
  setMetadataFor($executeWebSocketRequestCOROUTINE$17, '$executeWebSocketRequestCOROUTINE$17', classMeta, CoroutineImpl);
  ...
  setMetadataFor($toRawCOROUTINE$18, '$toRawCOROUTINE$18', classMeta, CoroutineImpl);
  ...
  function url(_this__u8e3s4, url) {
    takeFrom_1(_this__u8e3s4.get_url_18iuii_k$(), url);
  }
  ...
  function bodyAsText(_this__u8e3s4, fallbackCharset, $completion) {
    ...
    var tmp = new $bodyAsTextCOROUTINE$11(_this__u8e3s4, fallbackCharset, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  function bodyAsChannel(_this__u8e3s4, $completion) {
    var tmp = new $bodyAsChannelCOROUTINE$12(_this__u8e3s4, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  function $bodyAsTextCOROUTINE$11(_this__u8e3s4, fallbackCharset, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
    this.fallbackCharset_1 = fallbackCharset;
  }
  protoOf($bodyAsTextCOROUTINE$11).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  function $bodyAsChannelCOROUTINE$12(_this__u8e3s4, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this._this__u8e3s4__1 = _this__u8e3s4;
  }
  protoOf($bodyAsChannelCOROUTINE$12).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
        switch (tmp) {
          case 0:
            this.set_exceptionState_s9sevl_k$(2);
            this.set_state_a96kl8_k$(1);
            var tmp_0 = this._this__u8e3s4__1.get_call_wojxrb_k$();
            var tmp_1 = JsType_getInstance();
  ...
  protoOf($executeCOROUTINE$13).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf($executeUnsafeCOROUTINE$14).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf($cleanupCOROUTINE$15).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(HttpStatement).execute_ocvbo_k$ = function (block, $completion) {
    var tmp = new $executeCOROUTINE$13(this, block, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  protoOf(HttpStatement).executeUnsafe_lxe0js_k$ = function ($completion) {
    var tmp = new $executeUnsafeCOROUTINE$14(this, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  protoOf(HttpStatement).cleanup_n4xe9d_k$ = function (_this__u8e3s4, $completion) {
    var tmp = new $cleanupCOROUTINE$15(this, _this__u8e3s4, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  function executeWebSocketRequest($this, request, callContext, $completion) {
    var tmp = new $executeWebSocketRequestCOROUTINE$17($this, request, callContext, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  ...
  protoOf($executeCOROUTINE$16).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf($executeWebSocketRequestCOROUTINE$17).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
  ...
  protoOf(JsClientEngine).execute_95skru_k$ = function (data, $completion) {
    var tmp = new $executeCOROUTINE$16(this, data, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  };
  ...
  function awaitConnection$lambda($cancellable, $this_awaitConnection) {
    return function (event) {
      ...
      if (tmp0_subject === 'open') {
        ...
        var tmp2_resumeWithException = WebSocketException_init_$Create$(asString(event));
        var tmp$ret$2;
  ...
  function toRaw(_this__u8e3s4, clientConfig, callContext, $completion) {
    var tmp = new $toRawCOROUTINE$18(_this__u8e3s4, clientConfig, callContext, $completion);
    tmp.set_result_ximc09_k$(Unit_getInstance());
    tmp.set_exception_pwgeox_k$(null);
    return tmp.doResume_5yljmg_k$();
  }
  ...
  protoOf($toRawCOROUTINE$18).doResume_5yljmg_k$ = function () {
    var suspendResult = this.get_result_iyg5d2_k$();
    $sm: do
      try {
        var tmp = this.get_state_iypx7s_k$();
