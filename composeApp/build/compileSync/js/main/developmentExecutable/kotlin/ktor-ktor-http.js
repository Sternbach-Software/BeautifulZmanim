(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib-js-ir.js', './ktor-ktor-io.js', './ktor-ktor-utils.js', './kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib-js-ir.js'), require('./ktor-ktor-io.js'), require('./ktor-ktor-utils.js'), require('./kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js'));
  else {
    ...
    if (typeof this['kotlinx.coroutines-kotlinx-coroutines-core-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http'. Its dependency 'kotlinx.coroutines-kotlinx-coroutines-core-js-ir' was not found. Please, check whether 'kotlinx.coroutines-kotlinx-coroutines-core-js-ir' is loaded prior to 'ktor-ktor-http'.");
    }
    root['ktor-ktor-http'] = factory(typeof this['ktor-ktor-http'] === 'undefined' ? {} : this['ktor-ktor-http'], this['kotlin-kotlin-stdlib-js-ir'], this['ktor-ktor-io'], this['ktor-ktor-utils'], this['kotlinx.coroutines-kotlinx-coroutines-core-js-ir']);
  }
  ...
  var isSurrogate = kotlin_kotlin.$_$.li;
  var Char__plus_impl_qi7pgj = kotlin_kotlin.$_$.a4;
  var Char__minus_impl_a2frrh = kotlin_kotlin.$_$.z3;
  ...
  var Char__minus_impl_a2frrh_0 = kotlin_kotlin.$_$.y3;
  ...
  var contains = kotlin_kotlin.$_$.vh;
  var objectMeta = kotlin_kotlin.$_$.lf;
  var plus_2 = kotlin_kotlin.$_$.za;
  ...
  var last_0 = kotlin_kotlin.$_$.pi;
  var first = kotlin_kotlin.$_$.bi;
  ...
  var lineSequence = kotlin_kotlin.$_$.qi;
  var mapNotNull = kotlin_kotlin.$_$.jh;
  var toList = kotlin_kotlin.$_$.nh;
  ...
  var isWhitespace = kotlin_kotlin.$_$.mi;
  var startsWith = kotlin_kotlin.$_$.cj;
  var charArrayOf = kotlin_kotlin.$_$.ud;
  var split_0 = kotlin_kotlin.$_$.zi;
  ...
  var indexOfAny = kotlin_kotlin.$_$.di;
  ...
  var Companion_getInstance_0 = kotlin_io_ktor_ktor_io.$_$.h;
  ...
  var toLong_0 = kotlin_kotlin.$_$.pf;
  var take = kotlin_kotlin.$_$.ej;
  var firstOrNull = kotlin_kotlin.$_$.l9;
  var Map = kotlin_kotlin.$_$.f7;
  var Companion_getInstance_1 = kotlin_kotlin.$_$.b6;
  var checkIndexOverflow = kotlin_kotlin.$_$.z7;
  ...
  protoOf(Companion_0).parse_c6badr_k$ = function (value, init) {
    var headerValue = last(parseHeaderValue(value));
  ...
  protoOf(Companion_1).build_71vz7b_k$ = function (builder) {
    var tmp$ret$0;
    // Inline function 'kotlin.apply' call
  ...
  protoOf(Companion_2).parse_4mmrzm_k$ = function (method) {
  ...
  protoOf(Companion_3).fromValue_77kypm_k$ = function (name, major, minor) {
  ...
  protoOf(Companion_3).parse_dugsiw_k$ = function (value) {
    var tmp$ret$1;
  ...
  protoOf(Companion_4).fromValue_pw7q9m_k$ = function (value) {
  ...
  protoOf(HttpStatusCode).compareTo_42rru4_k$ = function (other) {
    return this.value_1 - other.value_1 | 0;
  };
  protoOf(HttpStatusCode).compareTo_6thzaj_k$ = function (other) {
    return this.compareTo_42rru4_k$(other instanceof HttpStatusCode ? other : THROW_CCE());
  };
  ...
  function isSuccess(_this__u8e3s4) {
    var containsArg = _this__u8e3s4.value_1;
  ...
  protoOf(Companion_5).build_s1b7o5_k$ = function (builder) {
    var tmp$ret$0;
    // Inline function 'kotlin.apply' call
  ...
  protoOf(Companion_7).createOrDefault_wgzdz5_k$ = function (name) {
    var tmp$ret$1;
    // Inline function 'kotlin.let' call
  ...
  function takeFrom_1(_this__u8e3s4, url) {
    ...
    _this__u8e3s4.set_host_fol6ab_k$(url.get_host_wonf8x_k$());
    _this__u8e3s4.set_port_ainwz6_k$(url.get_port_wosj4a_k$());
    set_encodedPath(_this__u8e3s4, url.get_encodedPath_p9zwnq_k$());
    _this__u8e3s4.set_encodedUser_rcoc99_k$(url.get_encodedUser_p9wcq8_k$());
    _this__u8e3s4.set_encodedPassword_94zcyl_k$(url.get_encodedPassword_rswp28_k$());
    var tmp$ret$0;
    // Inline function 'kotlin.apply' call
    ...
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'io.ktor.http.takeFrom.<anonymous>' call
    tmp0_apply.appendAll_4ib0tg_k$(parseQueryString(url.get_encodedQuery_28s95p_k$(), VOID, VOID, false));
    tmp$ret$0 = tmp0_apply;
    _this__u8e3s4.set_encodedParameters_kuhjhk_k$(tmp$ret$0);
    _this__u8e3s4.set_encodedFragment_t7lglr_k$(url.get_encodedFragment_jm6jcb_k$());
    _this__u8e3s4.set_trailingQuery_xabrx6_k$(url.get_trailingQuery_m2fl7h_k$());
  ...
  _.$_$.j = NoContent;
  _.$_$.k = ProtocolUpgrade;
  _.$_$.l = ReadChannelContent;
  _.$_$.m = WriteChannelContent;
  _.$_$.n = OutgoingContent;
  _.$_$.o = TextContent;
  _.$_$.p = HeadersBuilder;
  _.$_$.q = HttpMessageBuilder;
  _.$_$.r = HttpMessage;
