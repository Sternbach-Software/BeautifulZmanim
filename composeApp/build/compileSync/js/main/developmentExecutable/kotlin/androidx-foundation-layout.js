(function (root, factory) {
  ...
  var Companion_getInstance = kotlin_org_jetbrains_compose_ui_ui.$_$.x6;
  var roundToInt = kotlin_kotlin.$_$.xf;
  var IntSize = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.x;
  var InspectorValueInfo = kotlin_org_jetbrains_compose_ui_ui.$_$.s3;
  var get_NoInspectorInfo = kotlin_org_jetbrains_compose_ui_ui.$_$.e4;
  var foldIn = kotlin_org_jetbrains_compose_ui_ui.$_$.n5;
  var foldOut = kotlin_org_jetbrains_compose_ui_ui.$_$.o5;
  var any = kotlin_org_jetbrains_compose_ui_ui.$_$.m5;
  var all = kotlin_org_jetbrains_compose_ui_ui.$_$.l5;
  var then = kotlin_org_jetbrains_compose_ui_ui.$_$.p5;
  var ParentDataModifier = kotlin_org_jetbrains_compose_ui_ui.$_$.v2;
  var sourceInformation = kotlin_org_jetbrains_compose_runtime_runtime.$_$.w1;
  var Companion_getInstance_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.y6;
  ...
  var Companion_getInstance_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.t6;
  ...
  var Companion_getInstance_2 = kotlin_org_jetbrains_compose_runtime_runtime.$_$.j2;
  var isObject = kotlin_kotlin.$_$.ze;
  var get_isDebugInspectorInfoEnabled = kotlin_org_jetbrains_compose_ui_ui.$_$.f4;
  var Constraints = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.b;
  var minIntrinsicWidth = kotlin_org_jetbrains_compose_ui_ui.$_$.n2;
  var minIntrinsicHeight = kotlin_org_jetbrains_compose_ui_ui.$_$.m2;
  var maxIntrinsicWidth = kotlin_org_jetbrains_compose_ui_ui.$_$.l2;
  var maxIntrinsicHeight = kotlin_org_jetbrains_compose_ui_ui.$_$.k2;
  var MeasurePolicy = kotlin_org_jetbrains_compose_ui_ui.$_$.o2;
  ...
  var Placeable = kotlin_org_jetbrains_compose_ui_ui.$_$.y2;
  var Constraints__copy$default_impl_f452rp = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.j3;
  var Companion_getInstance_3 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.m3;
  ...
  var offset = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.n1;
  ...
  var minIntrinsicWidth_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.h2;
  var minIntrinsicHeight_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.g2;
  var maxIntrinsicWidth_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.f2;
  var maxIntrinsicHeight_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.e2;
  var LayoutModifier = kotlin_org_jetbrains_compose_ui_ui.$_$.i2;
  var Dp__compareTo_impl_tlg3dl = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.i2;
  var get_FirstBaseline = kotlin_org_jetbrains_compose_ui_ui.$_$.a2;
  var THROW_ISE = kotlin_kotlin.$_$.tk;
  var Enum = kotlin_kotlin.$_$.ek;
  var Companion_getInstance_5 = kotlin_org_jetbrains_compose_ui_ui.$_$.r6;
  ...
  var get_sign = kotlin_kotlin.$_$.ag;
  var coerceAtMost = kotlin_kotlin.$_$.lg;
  ...
  var coerceAtLeast = kotlin_kotlin.$_$.fg;
  var coerceAtLeast_0 = kotlin_kotlin.$_$.gg;
  ...
  var Companion_getInstance_6 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.s3;
  var modifierLocalOf = kotlin_org_jetbrains_compose_ui_ui.$_$.m3;
  //endregion
  ...
  setMetadataFor(SiblingsAlignedModifier, 'SiblingsAlignedModifier', classMeta, InspectorValueInfo, [ParentDataModifier, InspectorValueInfo]);
  setMetadataFor(WithAlignmentLineBlock, 'WithAlignmentLineBlock', classMeta, SiblingsAlignedModifier);
  setMetadataFor(WithAlignmentLine, 'WithAlignmentLine', classMeta, SiblingsAlignedModifier);
  setMetadataFor(VerticalAlignModifier, 'VerticalAlignModifier', classMeta, InspectorValueInfo, [ParentDataModifier, InspectorValueInfo]);
  ...
  function Box$composable_0(modifier, $composer, $changed) {
    _init_properties_Box_kt__tvzvdl();
    var $composer_0 = $composer;
    ...
    if (!(($dirty & 11) === 2) ? true : !$composer_0.get_skipping_3owdve_k$()) {
      ...
      // Inline function 'androidx.compose.ui.layout.Layout$composable.<anonymous>' call
      var tmp10__anonymous__yfiz50 = _Updater___init__impl__rbfxm8($composer_5);
      Updater__set_impl_v7kwss(tmp10__anonymous__yfiz50, tmp0_measurePolicy, Companion_getInstance_1().get_SetMeasurePolicy_on6ujt_k$());
      Updater__set_impl_v7kwss(tmp10__anonymous__yfiz50, density, Companion_getInstance_1().get_SetDensity_gmdtxr_k$());
      Updater__set_impl_v7kwss(tmp10__anonymous__yfiz50, layoutDirection, Companion_getInstance_1().get_SetLayoutDirection_w7ypuk_k$());
      Updater__set_impl_v7kwss(tmp10__anonymous__yfiz50, viewConfiguration, Companion_getInstance_1().get_SetViewConfiguration_lke0s8_k$());
      tmp7_ReusableComposeNode$composable(new SkippableUpdater(_SkippableUpdater___init__impl__4ft0t9($composer_5)), $composer_5, 112 & tmp9_ReusableComposeNode$composable >> 3);
  ...
  function Box$composable$lambda($modifier, $$changed) {
    return function ($composer, $force) {
      Box$composable_0($modifier, $composer, updateChangedFlags($$changed | 1));
      return Unit_getInstance();
    };
  }
  ...
  function Column$composable(modifier, verticalArrangement, horizontalAlignment, content, $composer, $changed, $default) {
    ...
    sourceInformation($composer_0, 'CC(Column$composable)P(2,3,1)77@3913L61,78@3979L133:Column.kt#2w3rfo');
    if (!(($default & 1) === 0))
      modifier_0 = Companion_getInstance_0();
    if (!(($default & 2) === 0))
    ...
    var tmp15__anonymous__a63r3d = 14 & tmp9_ReusableComposeNode$composable >> 9;
    var $composer_6 = tmp14__anonymous__f0seaw;
    sourceInformationMarkerStart($composer_6, 1633582135, 'C79@4027L9:Column.kt#2w3rfo');
  ...
  function ColumnScopeInstance$weight$lambda($weight, $fill) {
    return function ($this$null) {
      $this$null.set_name_1v3553_k$('weight');
      $this$null.set_value_rj6yh0_k$($weight);
      $this$null.get_properties_zhllqc_k$().set_y753qn_k$('weight', $weight);
      $this$null.get_properties_zhllqc_k$().set_y753qn_k$('fill', $fill);
      return Unit_getInstance();
    };
  }
  ...
  function ColumnScopeInstance$alignBy$lambda($alignmentLine) {
    return function ($this$null) {
      $this$null.set_name_1v3553_k$('alignBy');
      $this$null.set_value_rj6yh0_k$($alignmentLine);
      return Unit_getInstance();
    };
  }
  function ColumnScopeInstance$alignBy$lambda_0($alignmentLineBlock) {
    return function ($this$null) {
      $this$null.set_name_1v3553_k$('alignBy');
      $this$null.set_value_rj6yh0_k$($alignmentLineBlock);
      return Unit_getInstance();
    };
  }
  ...
  function padding_1(_this__u8e3s4, paddingValues) {
    ...
    var tmp;
    if (get_isDebugInspectorInfoEnabled()) {
      tmp = padding$lambda_1(paddingValues);
    } else {
      tmp = get_NoInspectorInfo();
    }
    tmp$ret$0 = tmp;
  ...
  function padding$lambda_0($all) {
    return function ($this$null) {
      $this$null.set_name_1v3553_k$('padding');
      $this$null.set_value_rj6yh0_k$(new Dp($all));
      return Unit_getInstance();
    };
  }
  function padding$lambda_1($paddingValues) {
    return function ($this$null) {
      $this$null.set_name_1v3553_k$('padding');
      $this$null.get_properties_zhllqc_k$().set_y753qn_k$('paddingValues', $paddingValues);
      return Unit_getInstance();
    };
  }
  ...
  function Row$composable(modifier, horizontalArrangement, verticalAlignment, content, $composer, $changed, $default) {
    ...
    sourceInformation($composer_0, 'CC(Row$composable)P(2,1,3)78@3913L58,79@3976L130:Row.kt#2w3rfo');
    if (!(($default & 1) === 0))
      modifier_0 = Companion_getInstance_0();
    if (!(($default & 2) === 0))
    ...
    var tmp15__anonymous__a63r3d = 14 & tmp9_ReusableComposeNode$composable >> 9;
    var $composer_6 = tmp14__anonymous__f0seaw;
    sourceInformationMarkerStart($composer_6, -1568371804, 'C80@4021L9:Row.kt#2w3rfo');
  ...
  protoOf(LayoutWeightImpl).get_weight_lbhkzl_k$ = function () {
    return this.weight_1;
  };
  protoOf(LayoutWeightImpl).get_fill_wom0ng_k$ = function () {
    return this.fill_1;
  };
  protoOf(LayoutWeightImpl).modifyParentData_x7ztp7_k$ = function (_this__u8e3s4, parentData) {
    var tmp$ret$0;
  ...
  protoOf(HorizontalAlignModifier).get_horizontal_2rwn8t_k$ = function () {
    return this.horizontal_1;
  };
  protoOf(HorizontalAlignModifier).modifyParentData_x7ztp7_k$ = function (_this__u8e3s4, parentData) {
    var tmp$ret$0;
    // Inline function 'kotlin.also' call
    var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
    var tmp0_also = tmp0_elvis_lhs == null ? new RowColumnParentData() : tmp0_elvis_lhs;
  ...
  protoOf(WithAlignmentLineBlock).get_block_ip8l7o_k$ = function () {
    return this.block_1;
  };
  protoOf(WithAlignmentLineBlock).modifyParentData_x7ztp7_k$ = function (_this__u8e3s4, parentData) {
    var tmp$ret$0;
    // Inline function 'kotlin.also' call
    var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
    var tmp0_also = tmp0_elvis_lhs == null ? new RowColumnParentData() : tmp0_elvis_lhs;
  ...
  protoOf(WithAlignmentLineBlock).equals = function (other) {
    if (this === other)
      return true;
  ...
  protoOf(WithAlignmentLineBlock).hashCode = function () {
    return hashCode(this.block_1);
  };
  protoOf(WithAlignmentLineBlock).toString = function () {
  ...
  protoOf(WithAlignmentLine).get_alignmentLine_xlj9o2_k$ = function () {
    return this.alignmentLine_1;
  };
  protoOf(WithAlignmentLine).modifyParentData_x7ztp7_k$ = function (_this__u8e3s4, parentData) {
    var tmp$ret$0;
    // Inline function 'kotlin.also' call
    var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
    var tmp0_also = tmp0_elvis_lhs == null ? new RowColumnParentData() : tmp0_elvis_lhs;
  ...
  protoOf(WithAlignmentLine).equals = function (other) {
    if (this === other)
      return true;
  ...
  protoOf(WithAlignmentLine).hashCode = function () {
    return hashCode(this.alignmentLine_1);
  };
  protoOf(WithAlignmentLine).toString = function () {
  ...
  protoOf(VerticalAlignModifier).get_vertical_6ev9z3_k$ = function () {
    return this.vertical_1;
  };
  protoOf(VerticalAlignModifier).modifyParentData_x7ztp7_k$ = function (_this__u8e3s4, parentData) {
    var tmp$ret$0;
    // Inline function 'kotlin.also' call
    var tmp0_elvis_lhs = parentData instanceof RowColumnParentData ? parentData : null;
    var tmp0_also = tmp0_elvis_lhs == null ? new RowColumnParentData() : tmp0_elvis_lhs;
  ...
  protoOf(VerticalAlignModifier).equals = function (other) {
    if (this === other)
      return true;
  ...
  protoOf(VerticalAlignModifier).hashCode = function () {
    return hashCode(this.vertical_1);
  };
  protoOf(VerticalAlignModifier).toString = function () {
  ...
  protoOf(SpacerMeasurePolicy).measure_i7pm3b_k$ = function (_this__u8e3s4, measurables, constraints) {
    ...
    tmp$ret$0 = _this__u8e3s4.layout$default_8ylrvs_k$(width, height, VOID, SpacerMeasurePolicy$measure$lambda);
    tmp$ret$1 = tmp$ret$0;
    return tmp$ret$1;
  };
  ...
  protoOf(PaddingValuesModifier).foldIn_u08fre_k$ = foldIn;
  protoOf(PaddingValuesModifier).foldOut_4ty55p_k$ = foldOut;
  protoOf(PaddingValuesModifier).any_hrontp_k$ = any;
  protoOf(PaddingValuesModifier).all_ctzlrs_k$ = all;
  protoOf(PaddingValuesModifier).then_5qw5wu_k$ = then;
  protoOf(RowScopeInstance).weight$default_ygsn3h_k$ = weight$default_0;
  protoOf(LayoutWeightImpl).foldIn_u08fre_k$ = foldIn;
  protoOf(LayoutWeightImpl).foldOut_4ty55p_k$ = foldOut;
  protoOf(LayoutWeightImpl).any_hrontp_k$ = any;
  protoOf(LayoutWeightImpl).all_ctzlrs_k$ = all;
  protoOf(LayoutWeightImpl).then_5qw5wu_k$ = then;
  protoOf(HorizontalAlignModifier).foldIn_u08fre_k$ = foldIn;
  protoOf(HorizontalAlignModifier).foldOut_4ty55p_k$ = foldOut;
  protoOf(HorizontalAlignModifier).any_hrontp_k$ = any;
  protoOf(HorizontalAlignModifier).all_ctzlrs_k$ = all;
  protoOf(HorizontalAlignModifier).then_5qw5wu_k$ = then;
  protoOf(SiblingsAlignedModifier).foldIn_u08fre_k$ = foldIn;
  protoOf(SiblingsAlignedModifier).foldOut_4ty55p_k$ = foldOut;
  protoOf(SiblingsAlignedModifier).any_hrontp_k$ = any;
  protoOf(SiblingsAlignedModifier).all_ctzlrs_k$ = all;
  protoOf(SiblingsAlignedModifier).then_5qw5wu_k$ = then;
  protoOf(WithAlignmentLineBlock).foldIn_u08fre_k$ = foldIn;
  protoOf(WithAlignmentLineBlock).foldOut_4ty55p_k$ = foldOut;
  protoOf(WithAlignmentLineBlock).any_hrontp_k$ = any;
  protoOf(WithAlignmentLineBlock).all_ctzlrs_k$ = all;
  protoOf(WithAlignmentLineBlock).then_5qw5wu_k$ = then;
  protoOf(WithAlignmentLine).foldIn_u08fre_k$ = foldIn;
  protoOf(WithAlignmentLine).foldOut_4ty55p_k$ = foldOut;
  protoOf(WithAlignmentLine).any_hrontp_k$ = any;
  protoOf(WithAlignmentLine).all_ctzlrs_k$ = all;
  protoOf(WithAlignmentLine).then_5qw5wu_k$ = then;
  protoOf(VerticalAlignModifier).foldIn_u08fre_k$ = foldIn;
  protoOf(VerticalAlignModifier).foldOut_4ty55p_k$ = foldOut;
  protoOf(VerticalAlignModifier).any_hrontp_k$ = any;
  protoOf(VerticalAlignModifier).all_ctzlrs_k$ = all;
  protoOf(VerticalAlignModifier).then_5qw5wu_k$ = then;
  ...
  _.$_$.o = padding_1;
  _.$_$.p = padding;
  _.$_$.q = rememberBoxMeasurePolicy$composable;
  _.$_$.r = rowMeasurePolicy$composable;
  _.$_$.s = size;
  _.$_$.t = widthIn;
  _.$_$.u = width;
  _.$_$.v = Arrangement_getInstance;
  _.$_$.w = BoxScopeInstance_getInstance;
  _.$_$.x = ColumnScopeInstance_getInstance;
  _.$_$.y = RowScopeInstance_getInstance;
  //endregion
  return _;
}));
